...
class Cheaper_Challenge:
    ...
    def data_discovery(self):
      ...
      try:
        ...
        #total de ciudades con negocios que aceptan tarjetas de credito y con ambiente adecuado para niños sin valores nulos en el Business_id
    ...
    def upload_files(self):
      ...
      try:
        ...
        #cargamos las credenciales y el bucket
        ...
        for index,item  in enumerate(zip(local_file,name_file)):
          with open(local_file[index], "r") as json_data:
            ...
            if pattern_found is True:
              ...
              blob = bucket.blob(name_file[index] +  dt_string + ".json")
